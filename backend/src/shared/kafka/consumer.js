...
function startConsumer(groupId, topic, eachMessageHandler) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                            ...
                            eachMessage: function (payload) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            _a.trys.push([0, 2, , 3]);
                                            return [4 /*yield*/, eachMessageHandler(payload)];
                                        case 1:
                                            _a.sent();
                                            return [3 /*break*/, 3];
                                        case 2:
                                            err_1 = _a.sent();
                                            console.error("❌ Error processing Kafka message:", err_1);
                                            return [3 /*break*/, 3];
                ...
                case 3:
                    _a.sent();
                    console.log("\u2705 Kafka consumer running for topic: ".concat(topic));
                    return [2 /*return*/];
            }
        });
    });
